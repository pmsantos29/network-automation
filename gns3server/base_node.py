...
class BaseNode:
    ...
    # Code added
    def __init__(self, name, node_id, project, manager, aux_console=None, console=None, console_type="telnet", aux=None, allocate_aux=False, linked_clone=True, wrap_console=False):
        ...
        # Code added
        if self._aux_console is not None:
            self._aux_console = self._manager.port_manager.reserve_tcp_port(self._aux_console, self._project)
        ...
        # Code added
        if self._aux_console is None:
            self._aux_console = self._manager.port_manager.get_free_tcp_port(self._project)
    ...
    async def close(self):
        ...
        # Code added
        if self._aux_console:
            self._manager.port_manager.release_tcp_port(self._aux_console, self._project)
            self._aux_console = None
