...
class QemuVM(BaseNode):
    ...
    async def _build_command(self):
        ...
        additional_options = additional_options.replace("%aux-console-port%", str(self._aux_console))
        ...
        for field in QEMU_OBJECT_SCHEMA["required"]:
            if field not in answer:
                try:
                    ...
                    if(field == "options"):
                        answer[field] = str(answer[field].replace('%aux-console-port%', str(self._aux_console)))
